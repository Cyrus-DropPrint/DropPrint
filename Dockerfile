...
# Download the official Cura AppImage, extract it silently, and copy out the CuraEngine binary
RUN wget https://github.com/Ultimaker/Cura/releases/download/5.7.2/UltiMaker-Cura-5.7.2-linux-X64.AppImage -O /tmp/Cura.AppImage && \
