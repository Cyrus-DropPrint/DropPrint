# FINAL BUILD v3 - Corrected with Qt Platform and AppImage Extraction
...
RUN apt-get update && apt-get install -y \
    ...
    python3-pip \
    libfuse2 \
    # Minimal Qt/XCB dependencies for AppImage's internal use, though offscreen should bypass most
    libgl1-mesa-glx \
    libegl1-mesa \
    libfontconfig1 \
    libglib2.0-0 \
